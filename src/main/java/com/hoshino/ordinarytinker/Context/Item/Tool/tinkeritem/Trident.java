...
import com.hoshino.ordinarytinker.Context.Entity.TinkerTrident;
import com.hoshino.ordinarytinker.Context.Util.ModifierLevel;
    ...
    public void releaseUsing(ItemStack stack, Level level, LivingEntity livingEntity, int duration) {
        if (livingEntity instanceof Player player) {
            ...
            if (i >= 10) {
                ...
                int j = ModifierUtil.getModifierLevel(stack, OrdinaryTinkerModifier.Riptide.getId());
                int k = ModifierUtil.getModifierLevel(stack, OrdinaryTinkerModifier.Crcs.getId());
