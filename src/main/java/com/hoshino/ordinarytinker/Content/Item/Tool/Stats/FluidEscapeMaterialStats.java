...
public record FluidEscapeMaterialStats(float base_consumption, float consumption_multiplier, float damage_reduction,
                                       float fluid_capability) implements IMaterialStats {
